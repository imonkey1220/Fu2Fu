...
public class Shop {
    ...
    public Shop(String topics_id, String companyId, String device, String deviceType, String description, String masterEmail, Long timeStamp, boolean connection, Map<String,Object> alert) {
